...
export const resupplyPoints: ResupplyPoint[] = [
  ...
  },
  {
    ...
    distanceFromTrail: 3.1,
    shuttleAvailable: true,
    notes: '3.1E. Post office, grocery, lodging, restaurants, CVS pharmacy, library, and shuttle options. Train service nearby.',
    services: ['grocery', 'post office', 'lodging', 'restaurants', 'train', 'pharmacy', 'library', 'camping', 'shuttle']
  },
