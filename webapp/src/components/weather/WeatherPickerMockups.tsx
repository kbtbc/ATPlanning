    ...
    <div className="bg-[var(--background-secondary)] border border-[var(--border)] rounded-xl px-5 py-4">
      ...
      <div className="flex justify-center px-4">
        <div className="flex items-center gap-2 w-full max-w-md">
          ...
          {/* GPS button — separate, generously sized */}
          <button className="flex items-center gap-2 px-5 py-2 rounded-lg bg-[var(--background)] border border-[var(--border)] text-sm font-medium text-[var(--foreground-muted)] hover:text-[var(--foreground)] hover:border-[var(--primary)] transition-colors shrink-0 whitespace-nowrap">
